...
#########OUR FUNCTIONS###############
from Process_LabelEthan import color_to_classes
   ...
   # Training process setup
    ...
    for epoch in range(total_epoch):
        for batch_idx, batch_sample in enumerate(train_loader):
            ...
            if batch_idx % (len(body_train)/configs['batch_train']/50) == 0:
